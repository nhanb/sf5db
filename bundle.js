...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tabletop = __webpack_require__(7);
	Tabletop.init({
...
/***/ function(module, exports) {
	...
	Elm.Components.MatchList = Elm.Components.MatchList || {};
	Elm.Components.MatchList.make = function (_elm) {
	   "use strict";
	   _elm.Components = _elm.Components || {};
	   _elm.Components.MatchList = _elm.Components.MatchList || {};
	   if (_elm.Components.MatchList.values) return _elm.Components.MatchList.values;
	   var _U = Elm.Native.Utils.make(_elm),
	   $Basics = Elm.Basics.make(_elm),
	   $Debug = Elm.Debug.make(_elm),
	   $Effects = Elm.Effects.make(_elm),
	   ...
	   var update = F2(function (action,model) {
	      var _p0 = action;
	      switch (_p0.ctor)
	      {case "FilterPlayer1": return {ctor: "_Tuple2",_0: _U.update(model,{nameFilter1: _p0._0}),_1: $Effects.none};
	         case "FilterPlayer2": return {ctor: "_Tuple2",_0: _U.update(model,{nameFilter2: _p0._0}),_1: $Effects.none};
	         case "FilterCharacter1": return {ctor: "_Tuple2",_0: _U.update(model,{charFilter1: _p0._0}),_1: $Effects.none};
	         case "FilterCharacter2": return {ctor: "_Tuple2",_0: _U.update(model,{charFilter2: _p0._0}),_1: $Effects.none};
	         default: return {ctor: "_Tuple2",_0: _U.update(model,{matches: _p0._0}),_1: $Effects.none};}
	   });
	   var UpdateMatches = function (a) {    return {ctor: "UpdateMatches",_0: a};};
	   var FilterCharacter2 = function (a) {    return {ctor: "FilterCharacter2",_0: a};};
	   var FilterCharacter1 = function (a) {    return {ctor: "FilterCharacter1",_0: a};};
	   var FilterPlayer2 = function (a) {    return {ctor: "FilterPlayer2",_0: a};};
	   var FilterPlayer1 = function (a) {    return {ctor: "FilterPlayer1",_0: a};};
	   var hasBothFields = F5(function (getField1,getField2,name1,name2,matches) {
	      var lowerName2 = $String.toLower(name2);
	      var lowerName1 = $String.toLower(name1);
	      var hasMatchingPlayers = function (match) {
	         var lowerP2 = $String.toLower(getField2(match));
	         var lowerP1 = $String.toLower(getField1(match));
	         return A2($String.contains,lowerName1,lowerP1) && A2($String.contains,lowerName2,lowerP2) || A2($String.contains,
	         lowerName1,
	         lowerP2) && A2($String.contains,lowerName2,lowerP1);
	      };
	      return A2($List.filter,hasMatchingPlayers,matches);
	   });
	   var hasSingleField = F4(function (getField1,getField2,query,matches) {
	      var lowerQuery = $String.toLower(query);
	      var hasMatchingField = function (match) {
	         return A2($String.contains,lowerQuery,$String.toLower(getField1(match))) || A2($String.contains,lowerQuery,$String.toLower(getField2(match)));
	      };
	      return A2($List.filter,hasMatchingField,matches);
	   });
	   var getMatchesWithPlayer = F3(function (name1,name2,matches) {
	      return _U.eq(name1,"") && _U.eq(name2,"") ? matches : _U.eq(name1,"") ? A4(hasSingleField,
	      function (_) {
	         return _.p1;
	      },
	      function (_) {
	      ...
	      name2,
	      matches) : _U.eq(name2,"") ? A4(hasSingleField,function (_) {    return _.p1;},function (_) {    return _.p2;},name1,matches) : A5(hasBothFields,
	      function (_) {
	         return _.p1;
	      },
	      function (_) {
	   ...
	   var getMatchesWithCharacter = F3(function (name1,name2,matches) {
	      return _U.eq(name1,"") && _U.eq(name2,"") ? matches : _U.eq(name1,"") ? A4(hasSingleField,
	      function (_) {
	         return _.p1Char;
	      },
	      ...
	      name2,
	      matches) : _U.eq(name2,"") ? A4(hasSingleField,function (_) {    return _.p1Char;},function (_) {    return _.p2Char;},name1,matches) : A5(hasBothFields,
	      function (_) {
	         return _.p1Char;
	      },
	      function (_) {
	   ...
	   var matchDataRow = function (match) {
	      return A2($Html.tr,
	      _U.list([]),
	      _U.list([A2($Html.td,_U.list([]),_U.list([$Html.text(function (_) {    return _.date;}(match))]))
	              ,A2($Html.td,_U.list([]),_U.list([$Html.text(function (_) {    return _.event;}(match))]))
	              ,A2($Html.td,_U.list([]),_U.list([$Html.text(function (_) {    return _.gameVersion;}(match))]))
	              ,A2($Html.td,_U.list([]),_U.list([$Html.text(function (_) {    return _.p1;}(match))]))
	              ,A2($Html.td,_U.list([]),_U.list([$Html.text(function (_) {    return _.p1Char;}(match))]))
	              ,A2($Html.td,_U.list([]),_U.list([$Html.text(function (_) {    return _.p2;}(match))]))
	              ,A2($Html.td,_U.list([]),_U.list([$Html.text(function (_) {    return _.p2Char;}(match))]))
	              ,A2($Html.td,
	              _U.list([]),
	              _U.list([function () {
	                 var p2 = function (_) {    return _.p2;}(match);
	                 var p1 = function (_) {    return _.p1;}(match);
	                 var winner = function (_) {    return _.winner;}(match);
	                 return _U.eq(winner,"P1") ? $Html.text(p1) : _U.eq(winner,"P2") ? $Html.text(p2) : $Html.text("<unknown>");
	              }()]))
	              ,A2($Html.td,_U.list([]),_U.list([$Html.text(function (_) {    return _.matchType;}(match))]))
	              ,A2($Html.td,
	              _U.list([]),
	              _U.list([A2($Html.a,_U.list([$Html$Attributes.href(function (_) {    return _.url;}(match))]),_U.list([$Html.text("Watch")]))]))
	              ,A2($Html.td,_U.list([]),_U.list([$Html.text(function (_) {    return _.notes;}(match))]))]));
	   };
	   var characterFilterInput = F2(function (address,action) {
	      return A2($Html.input,
	      _U.list([$Html$Attributes.type$("text")
	              ,$Html$Attributes.placeholder("Filter character name")
	              ,A3($Html$Events.on,"input",$Html$Events.targetValue,function (_p1) {    return A2($Signal.message,address,action(_p1));})]),
	      _U.list([]));
	   });
	   var playerFilterInput = F2(function (address,action) {
	      return A2($Html.input,
	      _U.list([$Html$Attributes.type$("text")
	              ,$Html$Attributes.placeholder("Filter player name")
	              ,A3($Html$Events.on,"input",$Html$Events.targetValue,function (_p2) {    return A2($Signal.message,address,action(_p2));})]),
	      _U.list([]));
	   });
	   var searchForm = function (address) {
	      return A2($Html.div,
	      _U.list([$Html$Attributes.id("search-form")]),
	      _U.list([A2(playerFilterInput,address,FilterPlayer1)
	              ,A2(playerFilterInput,address,FilterPlayer2)
	              ,A2(characterFilterInput,address,FilterCharacter1)
	              ,A2(characterFilterInput,address,FilterCharacter2)]));
	   };
	   var fields = _U.list(["Date","Event","Game version","P1","P1 Character","P2","P2 Character","Winner","Match Type","Video","Notes"]);
	   var matchesTable = function (model) {
	      return _U.eq(function (_) {    return _.matches;}(model),_U.list([])) ? A2($Html.div,_U.list([]),_U.list([$Html.text("Loading...")])) : A2($Html.table,
	      _U.list([]),
	      _U.list([A2($Html.thead,
	              ...
	              _U.list([]),
	              function () {
	                 var ths = function (value) {    return A2($Html.th,_U.list([]),_U.list([$Html.text(value)]));};
	                 return A2($List.map,ths,fields);
	              }())]))
	              ,A2($Html.tbody,
	              _U.list([]),
	              A2($List.map,
	              matchDataRow,
	              A3(getMatchesWithCharacter,
	              function (_) {
	                 return _.charFilter1;
	              }(model),
	              function (_) {
	                 return _.charFilter2;
	              }(model),
	              A3(getMatchesWithPlayer,
	              function (_) {
	                 return _.nameFilter1;
	              }(model),
	              function (_) {
	                 return _.nameFilter2;
	              }(model),
	              function (_) {
	                 return _.matches;
	              }(model)))))]));
	   ...
	   var view = F2(function (address,model) {
	      return A2($Html.div,_U.list([$Html$Attributes.$class("wrap")]),_U.list([searchForm(address),matchesTable(model)]));
	   });
	   var init = {ctor: "_Tuple2",_0: {matches: _U.list([]),nameFilter1: "",nameFilter2: "",charFilter1: "",charFilter2: ""},_1: $Effects.none};
	                     ...
	                     return function (g) {
	                        return function (h) {
	                           return function (i) {
	                              return function (j) {
	                                 return function (k) {
	                                    return {date: a,event: b,gameVersion: c,p1: d,p1Char: e,p2: f,p2Char: g,winner: h,matchType: i,url: j,notes: k};
	                                 };
	                              };
	                           };
	                        };
	   ...
	   var Model = F5(function (a,b,c,d,e) {    return {matches: a,nameFilter1: b,nameFilter2: c,charFilter1: d,charFilter2: e};});
	   var updateMatchesSignal = $Signal.map(UpdateMatches);
	   return _elm.Components.MatchList.values = {_op: _op
	                                             ,updateMatchesSignal: updateMatchesSignal
	                                             ,Model: Model
	                                             ,Match: Match
	                                             ,init: init
	                                             ,fields: fields
	                                             ...
	                                             ,characterFilterInput: characterFilterInput
	                                             ,matchesTable: matchesTable
	                                             ,matchDataRow: matchDataRow
	                                             ,hasSingleField: hasSingleField
	                                             ,hasBothFields: hasBothFields
	                                             ,getMatchesWithPlayer: getMatchesWithPlayer
	                                             ,getMatchesWithCharacter: getMatchesWithCharacter
	                                             ,FilterPlayer1: FilterPlayer1
	                                             ,FilterPlayer2: FilterPlayer2
	                                             ,FilterCharacter1: FilterCharacter1
	                                             ,FilterCharacter2: FilterCharacter2
	...
	Elm.Main.make = function (_elm) {
	   ...
	   var _U = Elm.Native.Utils.make(_elm),
	   $Basics = Elm.Basics.make(_elm),
	   $Components$MatchList = Elm.Components.MatchList.make(_elm),
	   $Debug = Elm.Debug.make(_elm),
	   $List = Elm.List.make(_elm),
	   $Maybe = Elm.Maybe.make(_elm),
	   $Result = Elm.Result.make(_elm),
	   ...
	   var _op = {};
	   var updateMatches = Elm.Native.Port.make(_elm).inboundSignal("updateMatches",
	   "List Components.MatchList.Match",
	   function (v) {
	      return typeof v === "object" && v instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.map(function (v) {
	         return typeof v === "object" && "date" in v && "event" in v && "gameVersion" in v && "p1" in v && "p1Char" in v && "p2" in v && "p2Char" in v && "winner" in v && "matchType" in v && "url" in v && "notes" in v ? {_: {}
	                                                                                                                                                                                                                            ...
	                                                                                                                                                                                                                            v.event)
	                                                                                                                                                                                                                            ,gameVersion: typeof v.gameVersion === "string" || typeof v.gameVersion === "object" && v.gameVersion instanceof String ? v.gameVersion : _U.badPort("a string",
	                                                                                                                                                                                                                            v.gameVersion)
	                                                                                                                                                                                                                            ,p1: typeof v.p1 === "string" || typeof v.p1 === "object" && v.p1 instanceof String ? v.p1 : _U.badPort("a string",
	                                                                                                                                                                                                                            v.p1)
	                                                                                                                                                                                                                            ,p1Char: typeof v.p1Char === "string" || typeof v.p1Char === "object" && v.p1Char instanceof String ? v.p1Char : _U.badPort("a string",
	                                                                                                                                                                                                                            v.p1Char)
	                                                                                                                                                                                                                            ,p2: typeof v.p2 === "string" || typeof v.p2 === "object" && v.p2 instanceof String ? v.p2 : _U.badPort("a string",
	                                                                                                                                                                                                                            v.p2)
	                                                                                                                                                                                                                            ,p2Char: typeof v.p2Char === "string" || typeof v.p2Char === "object" && v.p2Char instanceof String ? v.p2Char : _U.badPort("a string",
	                                                                                                                                                                                                                            v.p2Char)
	                                                                                                                                                                                                                            ,winner: typeof v.winner === "string" || typeof v.winner === "object" && v.winner instanceof String ? v.winner : _U.badPort("a string",
	                                                                                                                                                                                                                            v.winner)
	                                                                                                                                                                                                                            ,matchType: typeof v.matchType === "string" || typeof v.matchType === "object" && v.matchType instanceof String ? v.matchType : _U.badPort("a string",
	                                                                                                                                                                                                                            v.matchType)
	                                                                                                                                                                                                                            ,url: typeof v.url === "string" || typeof v.url === "object" && v.url instanceof String ? v.url : _U.badPort("a string",
	                                                                                                                                                                                                                            v.url)
	                                                                                                                                                                                                                            ,notes: typeof v.notes === "string" || typeof v.notes === "object" && v.notes instanceof String ? v.notes : _U.badPort("a string",
	                                                                                                                                                                                                                            v.notes)} : _U.badPort("an object with fields `date`, `event`, `gameVersion`, `p1`, `p1Char`, `p2`, `p2Char`, `winner`, `matchType`, `url`, `notes`",
	         v);
	      })) : _U.badPort("an array",v);
	   });
	   var app = $StartApp.start({init: $Components$MatchList.init
	                             ,view: $Components$MatchList.view
	                             ,update: $Components$MatchList.update
	                             ,inputs: _U.list([$Components$MatchList.updateMatchesSignal(updateMatches)])});
	   var main = app.html;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(process) {(function() {
	  ...
	  if (typeof process !== 'undefined' && !process.browser) {
	    inNodeJS = true;
	    var request = __webpack_require__(9)('request'.trim()); //prevents browserify from bundling the module
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./backbone.tabletopSync": 10,
		"./backbone.tabletopSync.js": 10,
		"./tabletop": 7,
		"./tabletop.js": 7
	};
